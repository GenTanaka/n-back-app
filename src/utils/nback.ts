 ...
 */
export function generateNBackSequence(n: number, length: number, targetRate: number): number[] {
  const arr: number[] = [];
 ...
 */
export function getCorrectAnswer(n: number, idx: number, arr: number[]): boolean | null {
